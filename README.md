...
[surfcat_864x480x56.webm](https://github.com/user-attachments/assets/b689da1b-3838-4985-9cbb-019502cf14d3)

> **Reproduce it exactly:** `examples/reproduce_demo.ps1` — one command, with the
> **verbatim prompt + all settings** baked in. Prompt / settings also in
> [`examples/run_command.md`](examples/run_command.md).

> 📜 **How we got here (the dead-ends & diagnosis):**
> [`docs/history/troubleshooting.md`](docs/history/troubleshooting.md).
